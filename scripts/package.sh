...
TARGET_DIR="${GETLATESTREPO_TARGET_DIR:-${HOME}/local-bin}"
TARGET_BIN="${GETLATESTREPO_TARGET_BIN:-${TARGET_DIR}/custom-getlatestrepo}"
GETREP_DIR="${GETLATESTREPO_GETREP_DIR:-${HOME}/.local/bin}"
GETREP_BIN="${GETLATESTREPO_GETREP_BIN:-${GETREP_DIR}/getrep}"
BINQUICK_FILE="${GETLATESTREPO_BINQUICK_FILE:-${HOME}/.binquick}"
